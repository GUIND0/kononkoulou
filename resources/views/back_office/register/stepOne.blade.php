        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Plus qu'une etape avant de rejoindre notre communauté.</p>

              <form id="formAuthentication" class="mb-3" action="{{ route('register.finalStep',$id) }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    <label for="email" class="form-label">Confirmation</label>
                    <input
                      type="password"
                      class="form-control"
                      name="password_confirmation" value="{{ old('password_confirmation') }}" id="password_confirmation" placeholder="...."
                      autofocus
                    />
